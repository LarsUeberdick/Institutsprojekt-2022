...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_StaticObj_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_StaticObj_t qt_meta_stringdata_StaticObj = {
    {
QT_MOC_LITERAL(0, 9) // "StaticObj"
...
const QMetaObject StaticObj::staticMetaObject = { {
    QMetaObject::SuperData::link<Objects::staticMetaObject>(),
    qt_meta_stringdata_StaticObj.offsetsAndSize,
    qt_meta_data_StaticObj,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_StaticObj_t
, QtPrivate::TypeAndForceComplete<StaticObj, std::true_type>
