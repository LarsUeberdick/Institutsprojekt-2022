...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Webcam_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Webcam_t qt_meta_stringdata_Webcam = {
    {
QT_MOC_LITERAL(0, 6) // "Webcam"
...
const QMetaObject Webcam::staticMetaObject = { {
    QMetaObject::SuperData::link<Input::staticMetaObject>(),
    qt_meta_stringdata_Webcam.offsetsAndSize,
    qt_meta_data_Webcam,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Webcam_t
, QtPrivate::TypeAndForceComplete<Webcam, std::true_type>
...
void *Webcam::qt_metacast(const char *_clname)
{
    ...
    return Input::qt_metacast(_clname);
}

int Webcam::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Input::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
